...
const SignUp = () => {
    ...
    return (
      <div className="w-full flex justify-center items-center h-screen bg-blue-800 flex-col"> 
      <h1 className='text-white font-bold text-2xl p-8'>Welcome to MyTinerary!</h1>
  <div className="card">
    <div className="card2">
      <form className="form flex flex-col gap-3 bg-blue-500 rounded-md shadow-md p-3" onSubmit={handleSubmit}>
        <p  className="text-center text-lg text-blue-950 font-bold my-2">Sign up</p>
