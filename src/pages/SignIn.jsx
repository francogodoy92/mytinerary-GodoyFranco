...
const SignIn = () => {
    ...
    return (
        <div className="w-full flex justify-center items-center h-screen flex-col bg-blue-800"> 
      ...
      <div className="card">
        <div className="card2">
          <form className="form flex gap-3 flex-col bg-blue-500 rounded-md shadow-md p-3" onSubmit={handleSubmit}>
            <p className="text-center text-lg text-blue-950 font-bold my-2 ">Login</p>
