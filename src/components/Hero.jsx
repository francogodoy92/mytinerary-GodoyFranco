...
function Hero() {
  return (
    <div className="pt-[3vh] flex flex-col md:flex-row justify-center items-center gap-3">
      <div className="border bg-gray-800 rounded-md p-7 text-white md:w-1/3 w-80 flex flex-col gap-5">
